...
dataFolderName <- "2020-12-21_14:50:20"
...
experiment_df <- stats_sp[, c("FileName", "Type", "Round", "BlockPropagation", "BAWithOutFinalStep", "BAWithFinalStep","ConsensusType", "BlockType","BlockHash")]
...
Advanced algorand with concurrency constant **10**

Dataset name is **`r dataFolderName`**

Number of machines is **`r number_of_machines`**

Bandwidth limit per process using Trickle: **tc rules with 4 cities**
